...
export function AdvancedWarningBanner() {
  ...
  return (
    <div className="bg-amber-50 border border-amber-300 rounded-xl px-4 py-3 flex items-start justify-between gap-4">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <div className="text-amber-600/80 text-xs mt-0.5">
      ...
      <button
        ...
        className="text-amber-500 hover:text-amber-700 text-lg flex-shrink-0 transition-colors leading-none"
      >
        ✕
      </button>
    </div>
